...
{
    public partial class CapstoneToDoListContext : DbContext
    {
        public CapstoneToDoListContext()
        {
        }

        public CapstoneToDoListContext(DbContextOptions<CapstoneToDoListContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=.\\SQLExpress;Database=CapstoneToDoList;Trusted_Connection=True;");
            }
        }
